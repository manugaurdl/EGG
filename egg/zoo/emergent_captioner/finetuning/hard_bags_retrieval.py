...
#------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    # bag_size, threshold, num_bags = 20,7,10
    # captioner = "blip2mistral_sr_lora_rank32"
    ...
    # for idx , bag in tqdm(enumerate(benchmark), total =num_bags):
    #     if idx == num_bags:
    #         break
    #     bag_img_feats = img_feats[bag]
...
if __name__ == "__main__":
    ...
    config["captions_type"] = "mistral_4"
