...
class MlpTransformer(nn.Module):
    def __init__(self, in_dim, h_dim, out_d=None, act=F.relu, dropout=0.0):
        super().__init__()
...
class TransformerMapper(nn.Module):
    ...
    def __init__(
        self,
        dim_clip: int,  # dimension of clip output embedding
        dim_embedding: int,  # dimension of gpt embedding size
        prefix_length: int,  # num constant prefix tokens
        clip_length: int,  # num of clip prefix tokens
        num_layers: int = 8,
    ):
